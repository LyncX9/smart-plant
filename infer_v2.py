...
def analyze_plant_v2(model, image_folder, out_dir="outputs_v2"):
...
if __name__ == "__main__":
    ...
    if os.path.exists(model_path):
        ...
        result = analyze_plant_v2(model, "sample_leaves")
        print("\n" + "="*50)
        print(json.dumps(result, indent=2))
    else:
        print(f"Model '{model_path}' not found!")
        print("Run 'python train_simple.py' first to train the model.")
